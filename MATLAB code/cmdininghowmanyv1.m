% Measuring When It's Crowded-Behaviors' Influence (V1)
%import data
Collins_output = readmatrix('version-1 Experiment Collins-spreadsheet');
...
%Food Trucks
%extract data:
Food_Trucks_output = readmatrix('version-1 Experiment Food Truck-spreadsheet');
...
title("Number of Students at Collins Every Five Ticks (Version 1)")
...
title("Number of Students at Food Trucks Every Five Ticks (Version 1)")
...
title("Average Number of Students at Each Food Source Every Five Ticks (Version 1)")

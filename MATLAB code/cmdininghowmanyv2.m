...
%import data
Collins_output = readmatrix('version-2 Experiment Collins-spreadsheet');
...
%Food Trucks
%extract data:
Food_Trucks_output = readmatrix('version-2 Experiment Food Truck-spreadsheet');
...
title("Number of Students at Collins Every Five Ticks (Version 2)")
...
title("Number of Students at Food Trucks Every Five Ticks (Version 2)")
...
title("Average Number of Students at Each Food Source Every Five Ticks (Version 2)")

...
to setup
  ...
  create-category-of-students blue campus-patches ;;campus-patches is a place-holder
...
to calculate-crowdedness
  ...
  ;; update the values that indicate how long the locations are crowded for
